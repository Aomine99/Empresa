    ...
    def on_treeReservas_cursor_changed(self,widget):
        try:
            ...
            if iter is not None:
                ...
                '''
                    Recuperar una lista en el que el numero de reserva coincida con la reserva seleccionada
                    si esta vacia no hacer nada pero si tiene datos cargarlos en la ventana factura
                '''
